			...
			<div class="content-wrap nopadding">
				...
				<div id="section-about" class="center page-section">
					...
					<div class="container clearfix">
						...
						<p class="lead divcenter bottommargin" style="max-width: 800px;">
							Giải pháp giúp bạn cách giải quyết về vấn đề tổ chức sự kiện<br>
							Cung cấp những công cụ đầy đủ giúp bạn dễ dàng quản lý những sự kiện của riêng mình với những tính năng tiện dụng và hiện đại
						</p>

						<p class="m-b-30" style="font-size: 16px;"><a href="#" data-scrollto="#section-services" data-easing="easeInOutExpo" data-speed="1250" data-offset="70" class="more-link">Tìm hiểu thêm <i class="icon-angle-right"></i></a></p>
						...
						<div class="row divcenter" style="max-width: 1000px;">
							...
							<div class="col-md-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="frontend/images/portfolio/mixed/7.jpg" alt="John Doe">
									...
									<div class="team-desc team-desc-bg">
										<div class="team-title"><h4>Nhanh chóng</h4></div>
									</div>
								</div>
							...
							<div class="col-md-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="frontend/images/portfolio/mixed/9.jpg" alt="Josh Clark">
									</div>
									<div class="team-desc team-desc-bg">
										<div class="team-title"><h4>Tiện dụng</h4></div>
									</div>
								</div>
							...
							<div class="col-md-4 bottommargin">
								...
								<div class="team">
									<div class="team-image">
										<img src="frontend/images/portfolio/mixed/6.jpg" alt="Mary Jane">
									</div>
									<div class="team-desc team-desc-bg">
										<div class="team-title"><h4>Hiệu quả</h4></div>
									</div>
								</div>
					...
					<div id="portfolio" class="portfolio grid-container portfolio-nomargin portfolio-full portfolio-masonry mixed-masonry clearfix">
						...
						<article class="portfolio-item pf-media pf-icons wide">
							<div class="portfolio-image">
								<a href="#">
									<img src="frontend/images/portfolio/mixed/1.jpg" alt="Open Imagination">
								</a>
						...
						<article class="portfolio-item pf-illustrations">
							<div class="portfolio-image">
								<a href="#">
									<img src="frontend/images/portfolio/mixed/2.jpg" alt="Locked Steel Gate">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
						...
						<article class="portfolio-item pf-graphics pf-uielements">
							<div class="portfolio-image">
								<a href="#">
									<img src="frontend/images/portfolio/mixed/3.jpg" alt="Mac Sunglasses">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
						...
						<article class="portfolio-item pf-media pf-icons wide">
							<div class="portfolio-image">
								<a href="#">
									<img src="frontend/images/portfolio/mixed/4.jpg" alt="Open Imagination">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
										<h3><a href="#">Open Imagination</a></h3>
						...
						<article class="portfolio-item pf-uielements pf-media wide">
							<div class="portfolio-image">
								<a href="#">
									<img src="frontend/images/portfolio/mixed/5.jpg" alt="Console Activity">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
						...
						<article class="portfolio-item pf-media pf-icons">
							<div class="portfolio-image">
								<a href="#">
									<img src="frontend/images/portfolio/mixed/6.jpg" alt="Open Imagination">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
										<h3><a href="#">Open Imagination</a></h3>
						...
						<article class="portfolio-item pf-uielements pf-icons">
							<div class="portfolio-image">
								<a href="#">
									<img src="frontend/images/portfolio/mixed/7.jpg" alt="Backpack Contents">
								</a>
								<div class="portfolio-overlay">
									<div class="portfolio-desc">
				...
				<div id="section-services" class="page-section notoppadding">
					...
					<div class="row common-height">
						...
						<div class="col-lg-4 d-none d-md-block" style="background: url('frontend/images/services/main-bg.jpg') center center no-repeat; background-size: cover;"></div>
						<div class="col-lg-8">
					...
					<div class="section parallax nomargin dark" style="background-image: url('frontend/images/page/testimonials.jpg'); padding: 150px 0;" data-bottom-top="background-position:0px 0px;" data-top-bottom="background-position:0px -300px;">
				...
				<div id="section-blog" class="container-fluid owl-carousel posts-carousel carousel-widget" data-margin="20" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4">
					@for($i = 0; $i < 3; $i++ )
						<div class="oc-item">
				...
				<!-- <div id="section-blog" class="page-section">
							...
							<div class="row topmargin clearfix">
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="entry-image nobottommargin">
												<a href="#"><img src="frontend/images/blog/1.jpg" alt="Paris"></a>
											</div>
										</div>
								...
								<div class="ipost col-md-6 bottommargin clearfix">
									<div class="row">
										<div class="col-lg-6">
											<div class="entry-image nobottommargin">
												<a href="#"><img src="frontend/images/blog/2.jpg" alt="Paris"></a>
											</div>
										</div>
										<div class="col-lg-6" style="margin-top: 20px;">
								...
								<div class="ipost col-md-6 bottommargin clearfix">
									<div class="row">
										<div class="col-lg-6">
											<div class="entry-image nobottommargin">
												<a href="#"><img src="frontend/images/blog/3.jpg" alt="Paris"></a>
											</div>
										</div>
										<div class="col-lg-6" style="margin-top: 20px;">
								...
								<div class="ipost col-md-6 bottommargin clearfix">
									<div class="row">
										<div class="col-lg-6">
											<div class="entry-image nobottommargin">
												<a href="#"><img src="frontend/images/blog/4.jpg" alt="Paris"></a>
											</div>
										</div>
										<div class="col-lg-6" style="margin-top: 20px;">
					...
					<div class="container topmargin-lg clearfix">
						...
						<div id="oc-clients" class="owl-carousel topmargin image-carousel carousel-widget" data-margin="80" data-loop="true" data-nav="false" data-autoplay="5000" data-pagi="false"data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="5" data-items-xl="6">
							...
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/1.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/2.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/3.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/4.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/5.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/6.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/7.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/8.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/9.png" alt="Clients"></a></div>
							<div class="oc-item"><a href="#"><img src="frontend/images/clients/10.png" alt="Clients"></a></div>
				...
				<div id="section-contact" class="page-section notoppadding">
					...
					<div class="row noleftmargin norightmargin bottommargin-lg common-height">
						...
						<div class="col-lg-4 col-md-6" style="background-color: #F5F5F5;">
							<div class="col-padding max-height">
								<h3 class="font-body t400 ls1">Liên hệ với chúng tôi</h3>
								...
								<div style="font-size: 16px; line-height: 1.7;">
									...
									<address style="line-height: 1.7;">
										...
										321/123 Võ Văn Kiệt, Phường An Khánh<br>
										Quận Ninh Kiều, Thành Phố Cần Thơ<br>
									</address>
									...
									<abbr title="Email Address"><strong>Email:</strong></abbr> wofl.alone613@gmail.com
								</div>
							</div>
						</div>
					</div>
					...
					<div id="section-feedback" class="container clearfix">
							...
							<div class="contact-widget">
								...
								<form class="nobottommargin" id="template-contactform" name="template-contactform" action="include/sendemail.php" method="post">
									...
									<div class="col_two_third col_last">
										<input type="text" id="template-contactform-subject" name="template-contactform-subject" value="" class="required sm-form-control border-form-control" placeholder="Tiêu đề" />
									</div>

									<div class="clear"></div>

									<div class="col_full">
										<textarea class="required sm-form-control border-form-control" id="template-contactform-message" name="template-contactform-message" rows="7" cols="30" placeholder="Tin nhắn của bạn"></textarea>
									</div>

									<div class="col_full center">
										<button class="button button-border button-circle t500 noleftmargin topmargin-sm" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Gửi đi</button>
										<br>
										<small style="display: block; font-size: 13px; margin-top: 15px;">Chúng tôi sẽ nhanh chóng liên lạc cho bạn trong vòng 6-8 giờ tới.</small>
									</div>
