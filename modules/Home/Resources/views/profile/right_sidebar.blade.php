<div class="list-group">
	...
	<a href="#" class="list-group-item list-group-item-action clearfix">Sự kiện của bạn <i class="icon-tasks float-right"></i></a>
	<a href="#" class="list-group-item list-group-item-action clearfix">Vé đã mua <i class="icon-credit float-right"></i></a>
