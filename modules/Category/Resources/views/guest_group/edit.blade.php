...
<div class="row">
    <div class="col-lg-5">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-material" method="post" action="{{ route('post.edit.guest_group',$data->id) }}">
                 {{ csrf_field() }}
                    <div class="form-body">
                        <div class="p-t-20">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="Nhập nhóm khách mời" value="{{ $data->title }}">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-12">
