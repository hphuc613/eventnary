    ...
    <div class="col-lg-5">
        <div class="card">
            <div class="card-header bg-info">
                <h4 class="m-b-0 text-white">Chỉnh sửa quận huyện</h4>
            </div>
            <div class="card-body">
                <form class="form-material" method="post" action="{{ route('post.edit.district',$data->id) }}">
                 {{ csrf_field() }}
                    <div class="form-body">
                        <div class="p-t-20">
                            <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <select class="form-control select2 custom-select" name="city_id">
                                                ...
                                                <option @if($data->city_id == $city->id) selected @endif value="{{ $city->id }}">{{ $city->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="Nhập tên quận huyện" value="{{ $data->title }}">
                                </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-12">
