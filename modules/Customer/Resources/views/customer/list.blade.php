            ...
            <div class="card card-body">
                <div class="row align-items-center">
                    <div class="col-md-4 col-lg-3 text-center">
                        <a href="{{ route('get.edit.customer',$val->id) }}"><img src="{{ asset('upload/image/user/'.$val->image) }}" alt="customer" class="img-circle img-fluid"></a>
                    </div>
                    <div class="col-md-8 col-lg-9">
                        <a href="{{ route('get.edit.customer',$val->id) }}">
                        ...
                        <div class="row">
                            <a class="btn btn-danger btn-xs full-width"alt="{{ route('get.delete.customer',$val->id) }}" id="del-warning">Xóa người dùng này</a>
                        </div>
                    </div>
                </div>
            </div>
