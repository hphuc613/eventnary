                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="ticket_id" class="form-control select2">
                                                        @foreach($tickets as $key => $val)
                                                            <option @if($data->ticket_id == $val->id) selected @endif value="{{ $val->id }}">{{ $val->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label">Tên người đại diện</label>
                                                    <input type="text" name="name" required class="form-control" placeholder="Nhập tên người mua" value="{{ $data->name }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Số điện thoại</label>
                                                    <input type="text" name="phone" required class="form-control" placeholder="Nhập số điện thoại" value="{{ $data->phone }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Email</label>
                                                    <input type="email" name="email" required class="form-control" placeholder="Nhập email" value="{{ $data->email }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Số vé</label>
                                                    <input type="number" name="quality" required class="form-control"  value="{{ $data->quality }}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
